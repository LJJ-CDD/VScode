...
{
    char out[57],e[29],t[57];
    int i=0,j=0;
    char C[57],D[29];
    myPermutation(K,out,56,*PC_1);  //置换选择1 --- 64位的密钥压缩成56位
    strcpy(C,out);      //C0
    strcpy(D,out+28);   //D0

    //char C[57] = {49,42,35,28,21,14,7,0,50,43,36,29,22,15,8,1,51,44,37,30,23,16,9,2,52,45,38,31,55,48,41,34,27,20,13,6,54,47,40,33,26,19,12,5,53,46,39,32,25,18,11,4,24,17,10,3};
    //char D[29] = {55,48,41,34,27,20,13,6,54,47,40,33,26,19,12,5,53,46,39,32,25,18,11,4,24,17,10,3};	
